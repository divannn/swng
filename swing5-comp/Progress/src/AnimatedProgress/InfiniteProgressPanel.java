...
public class InfiniteProgressPanel extends JComponent
    ...
    public void paintComponent(Graphics g) {
        if (started) {
            ...
            if (text != null && text.length() > 0) {
                ...
                layout.draw(g2, (float) (width - bounds.getWidth()) / 2, (float) (maxY
    ...
    private Area[] buildTicker() {
        ...
        for (double i = 0.0; i < (double) barsCount; i++) {
            ...
            AffineTransform toCenter = AffineTransform.getTranslateInstance(center.getX(), center
                    .getY());
            AffineTransform toBorder = AffineTransform.getTranslateInstance(45.0, -6.0);
            AffineTransform toCircle = AffineTransform.getRotateInstance(-i * fixedAngle, center
                    .getX(), center.getY());
    ...
    private class Animator
        ...
        public void run() {
            ...
            AffineTransform toCircle = AffineTransform.getRotateInstance(fixedIncrement, center
                    .getX(), center.getY());
