...
public class MagnifyingGlass extends JComponent
    ...
    public void paint(Graphics g) {
        ...
        Image scaleImg = grabImg
                .getScaledInstance(mySize.width, mySize.height, Image.SCALE_FAST/*Image.SCALE_SMOOTH*/);
        g.drawImage(scaleImg, 0, 0, null);
    }

    private Rectangle computeGrabRect() {
        // width, height are size of this comp / zoom
        int grabWidth = (int) (mySize.width / zoom);
        int grabHeight = (int) (mySize.height / zoom);
