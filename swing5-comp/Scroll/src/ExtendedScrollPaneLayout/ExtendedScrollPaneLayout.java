 ...
 *
 */
public class ExtendedScrollPaneLayout extends ScrollPaneLayout {
	...
	protected Component hleft, hright, vtop, vbottom;
			...
			if (vsbNeeded) {
				...
				if (vtop == null && vbottom == null)
					...
					if (vbottom != null) {
						...
						vbottom.setBounds(vsbR.x, vsbR.y + vsbR.height - dim.height, vsbR.width,
								dim.height);
					}
					vsb.setBounds(rect);
				}
			...
			if (hsbNeeded) {
				...
				if (hleft == null && hright == null)
					...
					if (hright != null) {
						...
						hright.setBounds(hsbR.x + hsbR.width - dim.width, hsbR.y, dim.width,
								hsbR.height);
					}
					hsb.setBounds(rect);
				}
