 ...
 *
 */
public class DraggableWindowDemo extends JPanel {
    ...
    public DraggableWindowDemo() {
        background = new ImageIcon(DraggableWindowDemo.class.getResource("calendar.png"))
                .getImage();
        highlight = new ImageIcon(DraggableWindowDemo.class.getResource("highlight.png"))
                .getImage();
        day_img = new ImageIcon(DraggableWindowDemo.class.getResource("day.png")).getImage();
    ...
    public static void main(String[] args) {
        ...
        DraggableWindowDemo ch = new DraggableWindowDemo();
        ch.setDate(new Date());
