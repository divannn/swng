...
/**
 * Can be used as: new TableColumnResizer(table);
 * Initial code was taken from JTableHeader 'cause it already has ability to resize columns. 
 * @author idanilov
 * 
 */
public class TableColumnResizer extends MouseInputAdapter {
	...
	public void mouseDragged(MouseEvent e) {
		...
		boolean headerLeftToRight = table.getTableHeader()
