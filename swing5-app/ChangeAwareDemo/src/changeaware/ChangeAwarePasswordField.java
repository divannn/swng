 ...
 *
 */
public class ChangeAwarePasswordField extends JPasswordField
	...
	public ChangeAwarePasswordField() {
		super();
		...
		putClientProperty(IChangeAware.SHOW_CHANGE, Boolean.TRUE.toString());
		putClientProperty(IChangeAware.SHOW_INCORRECTNESS, Boolean.TRUE.toString());
	}
	...
	public void markState() {
		stateValue = new String(getPassword());
		computeState();
	}
	...
	private void computeState() {
		if (stateValue != null) {
			isChanged = !stateValue.equals(new String(getPassword()));
